document.addEventListener('DOMContentLoaded', function () {
  ...
  /* Mobile dropdown toggles (About / Activities / Admissions / Gallery) */
  ...
  /* ---------- Reveal-on-scroll (matches homepage fade-in style) ---------- */
  ...
  /* ---------- Auto-sliding image sliders (every 2s, smooth fade) ---------- */
